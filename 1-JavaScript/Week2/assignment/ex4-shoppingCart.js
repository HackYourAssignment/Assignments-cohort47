...
function addToShoppingCart(item) {
  ...
  const theShoppingCart = `You bought ${listShoppingCart}!`; // Assign to a variable
  console.log(theShoppingCart); // Log the message
  return theShoppingCart; // Return the message string
}
