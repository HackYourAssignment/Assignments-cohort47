...
function main() {
  ...
  const partnerNames = ['Aida', 'Sara', 'Meron', 'Selam', 'Yohana'];
  const locations = ['Paris', 'New York', 'Tokyo', 'Sydney', 'London'];
  const jobTitles = ['Engineer', 'Designer', 'Teacher', 'Chef', 'Doctor'];
