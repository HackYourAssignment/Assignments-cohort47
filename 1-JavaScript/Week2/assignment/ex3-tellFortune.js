...
function main() {
  ...
  const partnerNames = ['Aida', 'Alsu', 'Aigul', 'Leisan', 'Vika'];

  const locations = ['Sabetta', 'Gydan', 'Novy Urengoy', 'Tambov', 'Primorye'];

  const jobTitles = ['engineer', 'mechanic', 'driver', 'gardener', 'cleaner'];
