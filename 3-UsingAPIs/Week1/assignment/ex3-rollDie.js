...
/*  original code :- calls still be in progress even when the error condition / async 
 promises :- With promises, once an outcome (resolved or rejected) is determined, any further actions are ignored.
 */
