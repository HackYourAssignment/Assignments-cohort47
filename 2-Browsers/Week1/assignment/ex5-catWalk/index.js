...
function catWalk() {
  ...
  if (
    cat.isDancing === false &&
    currentPosition + catWidth >= halfScreenWidth
  ) {
    cat.isDancing = true;
    catImage.src = cat.dancingCatImage;

    setTimeout(function () {
      catImage.src = cat.walkingCatImage;
      cat.isDancing = false;
    }, 5000);
  }

  if (currentPosition + catWidth >= screenWidth) {
    catImage.style.left = '0px';
  }
}
